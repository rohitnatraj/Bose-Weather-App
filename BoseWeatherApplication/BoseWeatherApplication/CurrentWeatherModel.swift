...
public class WeatherForecast:NSObject {
        var cityName:String?
        var date:String?
...
class CurrentWeatherModel:NSObject {
        ...
        func getCurrentWeatherFor(_ city:CityCoordinates) {
                if !city.isEmpty() {
                        ...
                        self.weatherService.fetchCurrentWeatherForLocationWith(latitude: city.lattitude!, longitude: city.longitude!, onSuccess: { (results) in
                                ...
                                currentWeather = self.parseCurrentWeather(results, city:city)
                                weatherForecast = self.parseForecast(results, city: city)
        ...
        func parseCurrentWeather(_ results:[String:Any], city:CityCoordinates) -> CurrentWeather {
        ...
        func parseForecast(_ results:[String:Any], city:CityCoordinates) -> [WeatherForecast] {
                var weatherForecast = [WeatherForecast]()
